...
public class ConstantesDePaintEvolution {
    ...
    public static final int MARGEN_ANCHO_PANTALLA_DIBUJO = 150;
    public static final int MARGEN_LARGO_PANTALLA_DIBUJO = 50;
